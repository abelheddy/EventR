...
const MainPage = () => {
    ...
    return (
      <div className={styles.mainPage}>
        ...
        {/* CATEGORÍAS - Sección completamente reorganizada */}
        <div className={styles.categoriesContainer}>
          {/* Título ahora centrado y arriba */}
        ...
        {/* EVENTOS DESTACADOS - Estructura modificada */}
        <div className={styles.featuredEventsContainer}>
          {/* Título centrado sobre el grid */}
        ...
        {/* PRÓXIMOS EVENTOS - Reestructurado */}
